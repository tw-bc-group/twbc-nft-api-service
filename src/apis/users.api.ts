...
api.post(baseUrl, async (req: Request, res: Response, next: NextFunction) => {
...
api.put(`${baseUrl}/:id`, validationMiddleware(CreateUserDto, 'body'), async (req: Request, res: Response, next: NextFunction) => {
  const { id } = req.params;
